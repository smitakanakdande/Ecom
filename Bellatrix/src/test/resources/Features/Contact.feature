...
Scenario: To verify required field is incomplete form should not submit  
Given Open the contact form
When Fill the form incomplete
Then Form should not submit


Scenario: To verify required field is fulfill and submit the form
